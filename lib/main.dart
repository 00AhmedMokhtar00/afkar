...
class AppState with ChangeNotifier {
  ...
  String chatId;
  String typer;
  void setid(String vid){id = vid;notifyListeners();}
  void setchatId(String vchatId){chatId = vchatId;notifyListeners();}
  void settyper(String vtyper){typer = vtyper;notifyListeners();}
  get getid => id;
  ...
  dynamic hh ;
  List<String> cat = [];
  void setData({String nam , String em , String ph , String img ,String abou, String addr , String prce , List<String> vall , dynamic hj}){
    name = nam;
    email = em;
    phone = ph;
    image = img;
