...
class IdeasInvestors extends StatefulWidget{
  @override
  _IdeasInvestorsState createState() => _IdeasInvestorsState();
}

class _IdeasInvestorsState extends State<IdeasInvestors> {
  List<String> titles =[];
  List<String> names =[];
  List<String> ids =[];
      ...
      body:Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, i){
            return allideasCard(context, titles[i] , names[i] , ids[i] , detailses[i] , domains[i] , pres[i] , proposals[i]);
          },
        ),
      )
      )
  ...
  Widget allideasCard(BuildContext context ,String title , String name ,String id , String details , String domain , String pre ,String proposel){
    return GestureDetector(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>IdeasDetails(id , name , details , domain , pre , proposel)));
        },
          child: Container(
